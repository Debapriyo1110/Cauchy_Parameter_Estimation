...
plot(alpha_0, abs(bias1_0), col = 2, type = "l", xlim = c(-0.5, 0.5), ylim = c(0, 0.10),
...
legend(-0.1, 0.08, legend = c(expression(hat(sigma[alpha])), "QD", "MLE"),
       col = c(2, 4, 6), lty = 1, cex = 0.6)

# Plot: MSE vs alpha
MSE1_0 = c(MSE1[50:99], MSE0_1, MSE1[100:149])
plot(alpha_0, MSE1_0, col = 2, type = "l", xlim = c(-0.5, 0.5), ylim = c(0, 1.5),
